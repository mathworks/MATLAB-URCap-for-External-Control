...
public class ExternalControlProgramNodeView
    ...
    public void buildUI(JPanel panel,
        ...
        try {
            BufferedImage image = ImageIO.read(this.getClass().getResource("/matlab_image_boundary.png"));
            Image scaledImage = image.getScaledInstance(533, 71, Image.SCALE_SMOOTH);
