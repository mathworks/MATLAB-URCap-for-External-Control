...
// 
//   Modified in September, 2022 by MathWorks Inc. to create URCap for MathWorks
//-- END LICENSE BLOCK ------------------------------------------------
...
package com.mathworks.mathworks_externalcontrol.impl;
...
public class ExternalControlInstallationNodeService
    ...
    public String getTitle(Locale locale) {
        return "MATLAB URCap for External Control";
    }
    ...
    public ExternalControlInstallationNodeContribution createInstallationNode(
        InstallationAPIProvider installationApiProvider,
        ExternalControlInstallationNodeView view,
        DataModel model,
        CreationContext context) {
        return new ExternalControlInstallationNodeContribution(
            installationApiProvider, view, model);
    }
}
